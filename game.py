...
player1 = Player([randint(0, game_size[0]), randint(0, game_size[1])], (255, 0, 0), 100, game_size)
player2 = Player([randint(0, game_size[0]), randint(0, game_size[1])], (0, 0, 255), 100, game_size)
